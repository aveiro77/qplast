    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit Sale</h3>
                <p class="text-subtitle text-muted">Edit sale details and line items.</p>
            </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('sales.update', $sale->id) }}" x-data
                    ...
                    <div x-data="itemsManager()" @submit.prevent="submitForm" class="card-section">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="button" class="btn btn-primary" @click="submitForm">Update Sale</button>
                        </div>
...
window.itemsManager = function() {
    ...
    const initialItems = saleDetails && Array.isArray(saleDetails) && saleDetails.length > 0 
        ? saleDetails.map(d => ({
        ...
        : [ { product_id: null, unit: '', quantity: 1, price: 0, subtotal: 0 } ];
